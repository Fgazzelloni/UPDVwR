...
These measurements are analyzed using an **algorithm** that considers the *varied spacing of temperature stations* around the globe and urban heat island effects.
