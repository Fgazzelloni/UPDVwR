...
date: '2022-04-01'
image: 'https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day1_part-to-whole.png'
image-alt: ''
description: 'Part to whole: The dataset used is from the TidyTuesday project and it contains information about college sports participation in the US from 2015 to 2019.'
...
For the first day of the #30DayChartChallenge 2022 the theme is "Part to whole". 


![US college sports](https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day1_part-to-whole.png)
...
```{r}
ggsave("day1_part_to_whole.png",width =  8.56, height =  8.44)
```
