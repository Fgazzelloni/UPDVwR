...
date: '2022-04-06'
image: 'https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day6_data_day.png'
image-alt: 'Data day'
...
Today for day 6 of the #30DayChartChallenge2022 the theme is "Data day".
I decided to use the "financing_healthcare" dataset from the {ourworldindata} R package to explore healthcare financing trends across different countries. The first visualization is a waffle chart that illustrates the distribution of different types of health insurance in the United States for selected years. The second visualization is a line plot comparing total health expenses across various countries over time, highlighting specific countries for better visibility.

![Data day](https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day6_data_day.png)
