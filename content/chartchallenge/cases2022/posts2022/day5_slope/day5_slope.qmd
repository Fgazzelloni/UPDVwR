...
date: '2022-04-05'
image: 'https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day5_slope.png'
image-alt: 'Slope'
description: 'Slope'
categories: Slope
...
Today for day 5 of the #30DayChartChallenge2022 the theme is "Slope". 

I decided to use the Digital Publications dataset from Project Oasis to compare the editorial budget vs revenue generation budget of the publications founded in 2010. The slope chart shows how much budget is allocated to editorial activities compared to revenue generation activities for each publication. Each publication is represented by a line connecting two points: one for the editorial budget and another for the revenue generation budget. The logos of the publications are added to enhance visual appeal and provide context.

![Slope](https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day5_slope.png)
