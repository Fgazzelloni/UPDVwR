...
date: '2022-04-04'
image: 'https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day4_flora.png'
image-alt: 'Flora'
description: 'Flora: IRIS dataset petal length and width'
categories: Flora
...
For day 4 of the #30DayChartChallenge2022 the theme is "Flora".   

I decided to use the well known IRIS dataset and represent the petal length and width of the three species of iris flowers (setosa, versicolor and virginica) using polar rose curves. Each flower is represented by a rose curve where the petal length influences the rotation and the petal width the size of the flower. The flowers are placed on a grid with some random jitter to make it more lively. Stems are drawn from each flower to the bottom of the plot.

![Flora](https://raw.githubusercontent.com/Fgazzelloni/30DayChartChallenge/refs/heads/main/data/Edition_2022/images/day4_flora.png)
