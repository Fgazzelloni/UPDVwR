...
description: '`Globe` map, data is from `rnaturalearth`.'
categories: ['Globe','rnaturalearth']
output: html_document
execute: 
   eval: false
---

<center>![Globe](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2021/day28_earth_not_flat/earth_not_flat.png)</center>
