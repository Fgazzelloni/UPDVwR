...
image-alt: 'Raster Map'
description: 'Raster Map: this map of Alaska uses a raster file to represent elevation data, with colors indicating different elevation levels.'
categories: ['Raster','Alaska']
...
<center>
![Alaska Raster Map](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2023/day21_raster/day21_raster.png)</center>
```{r}
