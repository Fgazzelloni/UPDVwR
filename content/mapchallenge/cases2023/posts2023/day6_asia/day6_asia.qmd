...
image-alt: 'Asia Map'
description: 'Asia Map: This map visualizes population estimates for regions and major cities in Asia, using data from Wikipedia and geocodes obtained via the ggmap package.'
categories: ['Asia','Population']
...
<center>
![Asia](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2023/day6_asia/day6_asia.png)</center>
