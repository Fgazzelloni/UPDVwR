...
image-alt: 'this-a-chart-or-a-map'
description: 'This is a bubble chart on a Map. Data is from tmap::data("World"). Here the size of the bubbles is weighted by the absolute level of regression residuals from a linear model predicting life expectancy based on population estimates and well-being indicators.'
output: html_document
categories: 
  - "this-a-chart-or-a-map"
  - "bubble-chart"
  - "World"
execute: 
   eval: false
...
<center>
![This is a bubble chart on a Map](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2023/day28_is-this-a-chart-or-a-map/day28_is-this-a-chart-or-a-map.png)</center>
Load libraries
```{r}
library(tidyverse)
library(sf)
