...
image-alt: 'Hexagons Map'
description: 'Hexagons map of Covid19 data in Italy using {covid19italy} package: this map visualizes Covid19 cases across different regions of Italy using hexagonal grid cells to represent data density and distribution.'
categories: ['Hexagons','Italy','Covid19']
...
<center>
![Italy](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2023/day9_hexagons/day9_hexagons.png)</center>
