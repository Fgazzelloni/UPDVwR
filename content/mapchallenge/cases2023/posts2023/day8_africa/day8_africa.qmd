...
image-alt: 'Africa Map'
description: 'Africa Map: this map shows the total fertility rate by country in Africa for the year 2021, using data from the US Census Bureau International Data Base API and visualized with R.'
categories: ['Africa','Census Data']
...
<center>
![Africa](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2023/day8_africa/day8_africa.png)</center>
