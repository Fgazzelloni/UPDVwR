...
image-alt: 'Food / Drink Map'
description: 'Map of European Countries Foodborne Campylobacter Outbreaks'
categories: ['Food - Drink','Europe']
output: html_document
execute: 
   eval: false
---

![Europe](https://raw.githubusercontent.com/Fgazzelloni/30DayMapChallenge/master/2022/day15_food_drink/day15_food_drink.png)
...
df3 <- df2%>%
  ...
  mutate(agent=case_when(str_detect(agent,
                                    "other|Other|unknwon|Unknown") ~ "Other",
                         TRUE~agent)) %>%
  filter(!agent=="Other")
```
