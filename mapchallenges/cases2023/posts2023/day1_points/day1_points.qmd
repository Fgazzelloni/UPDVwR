...
This is a map of the `Bovine Tuberculosis`, locations of cattle herds in Cornwall (United Kingdom) tested positive for bovine tuberculosis over the years 1989-2002. data is from the `{spatstat}` package.
